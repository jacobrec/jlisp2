...
#define p(t) (printbits(t.data), printf("%s: [%s]\n", jlisp_typeof(t), jlisp_value_to_string(t)))
    ...
    vm.stack->size = 0;
    char data8[] = {
        0x0b, 0x09, 0x03, 0x01, 0x01, 0x08, 0x02, 0x01, 0x02, 0x14, 0x0b, 0x09,
        0x07, 0x01, 0x01, 0x01, 0x02, 0x0d, 0x11, 0x11, 0x08, 0x06, 0x00, 0x04,
        0x31, 0x20, 0x32, 0x00, 0x14, 0x0b, 0x09, 0x02, 0x0d, 0x08, 0x01, 0x0c,
        0x03
    };
